...
window.renderMissionHUD=function(ctx,W,H){ if(_r)_r(ctx,W,H);
  ...
  if(!window._stationPinAdded){window._stationPinAdded=true;if(window.mapPins)window.mapPins.push({x:window.stationPos.x,y:window.stationPos.y,color:'#48f',label:'УЧАСТОК'});}
