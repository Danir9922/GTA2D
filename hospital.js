...
(function(){
var HBI=4, HBJ=4;
window._hospitalPinAdded=false;
...
window.renderMissionHUD=function(ctx,W,H){ if(_r)_r(ctx,W,H);
  ...
  if(!window._hospitalPinAdded){window._hospitalPinAdded=true;if(window.mapPins)window.mapPins.push({x:window.hospitalPos.x,y:window.hospitalPos.y,color:'#f44',label:'БОЛЬНИЦА'});}
